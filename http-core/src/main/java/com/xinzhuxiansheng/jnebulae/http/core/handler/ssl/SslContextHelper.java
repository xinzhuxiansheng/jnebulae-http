package com.xinzhuxiansheng.jnebulae.http.core.handler.ssl;
...
public class SslContextHelper {
    ...
    private static String getKey(String keyPath,String keyPassword){
        ...
        System.out.println("MD5加密： "+Hashing.hmacMd5(keyStr.getBytes()).toString());
        return Hashing.hmacMd5(keyStr.getBytes()).toString();
    }
